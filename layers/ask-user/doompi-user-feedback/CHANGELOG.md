...
- Publish a reusable, disposable autonomous-voice question handoff for nonblocking cross-extension prompts.
- Include narrated question text in terminating voice tool results so non-questionnaire tools can render the handoff plainly.

## 0.0.1-alpha.3 (2026-08-15)
