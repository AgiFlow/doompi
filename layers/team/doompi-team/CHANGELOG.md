...
- **root:** repair import paths after service relocation ([e37d5947](https://github.com/AgiFlow/doompi/commit/e37d5947))
...
- **root:** refresh migration compatibility artifacts ([13833159](https://github.com/AgiFlow/doompi/commit/13833159))
...
- **doompi-team:** open a run's conversation in its own tab and launch agents from a catalog ([6e83069](https://github.com/AgiFlow/doompi/commit/6e83069))
...
- **doompi-web:** render markdown, preview @file mentions, and manage sessions from the cockpit ([59ea07d](https://github.com/AgiFlow/doompi/commit/59ea07d))
- **doompi-team:** every TUI contributor ships its web plugin equivalent ([931976c](https://github.com/AgiFlow/doompi/commit/931976c))

### 🩹 Fixes

- **doompi-team:** let detached SDK runners resolve the Pi SDK in managed installs ([a283dd5](https://github.com/AgiFlow/doompi/commit/a283dd5))
...
- **doompi:** improve autonomous voice handoffs (78fa3610)
...
- refine task and subagent tool rendering (d9baa62)
...
- **doompi:** harden progress and worker resolution (448935e)
...
- **doompi-team:** honor configured model precedence (d67340b)
