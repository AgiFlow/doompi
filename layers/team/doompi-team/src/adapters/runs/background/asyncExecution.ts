...
import { scopeResultsDir, sessionScopeEnvironment, scopeRunsDir, type SessionScope } from '../../filesystem/paths';
import type { ActivityState, ArtifactDirPreference } from '../../../types';
import {
  childProcessEndpoint,
  ExternalProcessIpc,
  type ExternalProcessEndpoint,
} from '../../process/externalProcessIpc';
import {
