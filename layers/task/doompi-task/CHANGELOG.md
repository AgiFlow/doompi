...
- reserve task tracking for complex jobs ([c562095](https://github.com/AgiFlow/doompi/commit/c562095))
...
- **doompi-task:** deduplicate task snapshots (d7f2f206)
...
- **doompi-task:** enforce task board limits (0cc04b51)
