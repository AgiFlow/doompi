...
export default defineCliTool((context: WithRoot<PiPluginContext, TaskPiScope>) =>
  definePiTool(createTaskTool(context.root.toolDependencies)),
);
...
export function createTaskTool(
  ...
  renderers: Pick<ToolDefinition<typeof TaskParamsSchema, ToolResult['details']>, 'renderCall' | 'renderResult'> = {},
): ToolDefinition<typeof TaskParamsSchema, ToolResult['details']> {
