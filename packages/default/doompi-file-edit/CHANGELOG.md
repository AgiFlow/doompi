...
- **doompi-file-edit:** attribute a bash change only when the write lands in the call ([3cba27c](https://github.com/AgiFlow/doompi/commit/3cba27c))
...
- **root:** invalidate tasks on dependency changes ([7e4a1e7](https://github.com/AgiFlow/doompi-internal/commit/7e4a1e7))
