import {
  ...
  BYTES_PER_MB,
  ERROR_WINDOW_CHARS,
  MAX_VARIANTS_TRACKED,
  MIN_SHARED_AFFIX,
  PRAGMA_BYTES_CEILING,
  PRAGMA_LINES_CEILING,
  PRAGMA_PATTERN,
  PRAGMA_TOKENS_CEILING,
} from '../../constants/bashResult';
import type {
  ErrorLineScanner,
  Excerpt,
  LogSummarizer,
