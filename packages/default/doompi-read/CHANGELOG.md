...
- Updated @agimon-ai/doompi-hashline to 0.0.1-alpha.54
...
- Updated @agimon-ai/doompi-hashline to 0.0.1-alpha.50
...
- Updated @agimon-ai/doompi-hashline to 0.0.1-alpha.40
...
- Replace Pi's `read` tool with snapshot-bound hashline output.
- Preserve Pi image reads, offsets, limits, and text truncation behavior.
