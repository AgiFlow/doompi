import type {
  ...
  VoiceTranscriptAdmissionAssessment,
  VoiceTranscriptAdmissionInput,
  VoiceTranscriptAdjudicationInput,
  VoiceTranscriptAdjudicationDecision,
  VoiceTranscriptAdmissionModelRequest,
  IVoiceTranscriptAdmissionModelClient,
  IVoiceTranscriptAdjudicator,
} from './type';
export type {
  VoiceTranscriptClassifier,
  VoiceTranscriptSignalEvidence,
  RecentVoiceTranscript,
  VoiceTranscriptAdmissionReason,
  VoiceTranscriptAdmissionAssessment,
  VoiceTranscriptAdmissionInput,
  VoiceTranscriptAdjudicationInput,
  VoiceTranscriptAdjudicationDecision,
