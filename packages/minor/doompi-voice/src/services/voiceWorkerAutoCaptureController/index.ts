...
import type { IVoiceCommandCorrector, VoiceCommandContext } from '../commandCorrection';
import type { IVoiceNarrationCompactor, IVoiceTurnFallbackNarrator } from '../fallbackNarration';
