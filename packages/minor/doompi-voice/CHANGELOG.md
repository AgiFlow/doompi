...
- stabilize voice capture and headless session lifecycle ([#171](https://github.com/AgiFlow/doompi/pull/171))
...
- **doompi-voice:** stabilize transcription and tool refresh ([f25f14e2](https://github.com/AgiFlow/doompi/commit/f25f14e2))
...
- **doompi-voice:** announce the composer error as a live status ([4a7a603](https://github.com/AgiFlow/doompi/commit/4a7a603))
...
- expand workflow cockpit and voice composition ([4917a2b](https://github.com/AgiFlow/doompi/commit/4917a2b))
- expand package APIs and upgrade Pi to 0.84.3 ([0aaad92](https://github.com/AgiFlow/doompi/commit/0aaad92))
- **doompi-voice:** show voice in the activity dock ([ae3314f](https://github.com/AgiFlow/doompi/commit/ae3314f))
...
- Add session-scoped voice capability façades and fresh-identity reload continuation.
- Render voice capability discovery and batches with compact Doom tool chrome and structured results.
...
- **doompi:** add task narration and intentional voice barge-in (7b56bc2)
...
- **doompi-voice:** preserve complete final narration (cb4203a)
- **root:** preserve narration and quiet proxy warnings (80db27c)
...
- **doompi-voice:** recover after narration failures (7413218)
- **doompi-voice:** keep narration updates concise (55df2eb)
