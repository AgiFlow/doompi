...
import { createVoiceMediaApi, type VoiceMediaApiOptions } from '../src/adapters/clientMediaApi.ts';
import { createVoiceSessionApi, type VoiceSessionApiOptions } from '../src/adapters/voiceSessionApi.ts';
