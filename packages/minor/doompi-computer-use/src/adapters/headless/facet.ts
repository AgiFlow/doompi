...
import type { MinorModeOwnerHandle } from '@agimon-ai/doompi-extension-contracts/mode';
import type { Context } from '@deepseek-ai/cordis';
import { COMPUTER_USE_MODE_ID, COMPUTER_USE_TOOL_NAMES, modeState } from '../pi/extension.ts';
import path from 'node:path';
import { createComputerUseSessionClient } from '../pi/sessionApiClient.ts';
import { ComputerScriptRunner } from '../pi/computerScriptRunner.ts';
...
const COMMAND_NAME = 'computer-use';
const COMMAND_DESCRIPTION = 'Inspect or manage the session computer use mode';
...
export const computerUseHeadlessFacet: HeadlessFacet = {
  ...
  apply(context: Context) {
    ...
    modeOwner = host.registerMinorMode({
      ...
      initialState: modeState(state, modeSelected()),
...
export default computerUseHeadlessFacet;
