...
import { catalog, filterCatalog, selectWorkflow, setCatalogFilter, toggleInspect } from '../_lib/catalogStore';
...
export function WorkflowCatalogDrawer({
  ...
  return (
    <aside
      ...
      tabIndex={0}
      onKeyDown={onKeyDown}
      className="flex w-[min(440px,calc(100vw-24px))] max-w-full shrink-0 flex-col overflow-hidden border-l border-doom-border bg-doom-rail outline-none"
    >
