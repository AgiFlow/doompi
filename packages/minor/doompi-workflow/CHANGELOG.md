...
- **doompi-workflow:** satisfy jsx-a11y rules in the artifacts pane ([6bddc6a](https://github.com/AgiFlow/doompi/commit/6bddc6a))
...
- **doompi-workflow:** redesign workflow run navigation ([c40c56d](https://github.com/AgiFlow/doompi/commit/c40c56d))
...
- **doompi-web:** bundle the cockpit from installed plugins, not hardcoded deps ([a763d80](https://github.com/AgiFlow/doompi/commit/a763d80))
- **doompi-workflow:** own the cockpit workflows tab end to end ([45b1fb8](https://github.com/AgiFlow/doompi/commit/45b1fb8))
