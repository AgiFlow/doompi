...
import type { ActiveGoal, GoalStateData, LoadedGoalState, SafetyPauseCause } from '../types/goal';
import { isNonNegativeFiniteNumber, nonNegativeFiniteNumber, normalizeTokenBudget } from './accounting';
