...
const OWNED_PACKAGE_DIRECTORIES: Readonly<Record<string, string>> = {
  '@agimon-ai/doompi': 'packages/cli/doompi',
  ...
  '@agimon-ai/doompi-minor-mode': 'packages/foundations/doompi-minor-mode',
  ...
  '@agimon-ai/doompi-major-mode': 'packages/foundations/doompi-major-mode',
  '@agimon-ai/doompi-mcp': 'packages/default/doompi-mcp',
  '@agimon-ai/doompi-notification': 'packages/foundations/doompi-notification',
  '@agimon-ai/doompi-plan': 'packages/minor/doompi-plan',
  '@agimon-ai/doompi-profile': 'packages/foundations/doompi-profile',
  ...
  '@agimon-ai/doompi-session': 'packages/foundations/doompi-session',
...
function packageLayerFor(relativeDirectory: string): PackageLayer {
  ...
  if (relativeDirectory.startsWith('packages/cli/')) return 'core';
  if (relativeDirectory.startsWith('packages/foundations/')) return 'foundations';
