...
it('resolves the skill authoring skill from source and compiled module locations', async () => {
  const skill = 'src/prompts/doompi-author-skill/SKILL.md';
  ...
  expect(content).toContain('doompi-author-skill');
