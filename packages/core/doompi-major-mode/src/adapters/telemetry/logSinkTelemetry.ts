...
import type { MajorModeTelemetry } from '../../types/telemetry.ts';

const SERVICE_NAME = 'doom-pi-major-mode';
const PACKAGE_NAME = '@agimon-ai/doompi-major-mode';

export interface MajorModeTelemetryOptions {
  cwd?: string;
...
export function createMajorModeTelemetry(options: MajorModeTelemetryOptions = {}): MajorModeTelemetry {
