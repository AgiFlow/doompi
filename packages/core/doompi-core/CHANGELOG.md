...
- **doompi-core:** load Pi settings packages so custom providers reach sessions and settings ([#202](https://github.com/AgiFlow/doompi/pull/202))
...
- Updated @agimon-ai/vibe-lint-plugin-doom-core to 0.0.1-alpha.10
...
- Updated @agimon-ai/vibe-lint-plugin-doom-core to 0.0.1-alpha.7
...
- Updated @agimon-ai/vibe-lint-plugin-doom-core to 0.0.1-alpha.6
