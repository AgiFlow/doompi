...
import { pairingPageHeaders, pairingPageHtml } from './pairingPage.ts';
import type { GuardListener } from './remoteGuardPolicy.ts';
import { isStepUpAction } from './webauthnPolicy.ts';
import {
  DEVICE_COOKIE,
  PAIRING_CLAIM_ROUTE,
  PAIRING_PAGE_ROUTE,
