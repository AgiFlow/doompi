...
import { missingLayerPackageSpecifiers } from '../services/layerPackageInstaller';
import { resolveDoomConfigurationRoot } from '../services/repository';
import { readLocatedSyncState } from '../services/syncState';
import { loadDoomConfig } from '../services/projectTrust';
...
import { collectDrift, selectionCompositionFingerprint, selectionEnvironment, toSelection } from './syncCommand';
