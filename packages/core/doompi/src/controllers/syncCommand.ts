...
import { ensureLayerPackages, missingLayerPackageSpecifiers } from '../services/layerPackageInstaller';
import { readBootstrapStatus } from '../services/bootstrapLocator';
import { DOOM_PACKAGE_NAME } from '../services/doomPackage';
import { doomPiPackageRoot, piExtensionAliasIsCurrent, writePiExtensionAlias } from '../services/piExtensionAlias';
import {
  PI_DISPATCHER_VERSION,
  piExtensionDispatcherIsUpgradeable,
  piExtensionDispatcherVersion,
} from '../services/piExtensionDispatcher';
import {
  mergePiSettings,
  piAgentDirectory,
  piThemeDirectory,
...
import { buildSyncedRuntime } from '../services/syncedRuntimeBuilder';
import { acquireSyncLocationLock, resolveSyncLocation, syncGenerationDirectory } from '../services/syncLocation';
import {
  publishSyncRegistration,
  SYNC_REGISTRATION_VERSION,
  syncStateSha256,
  type SyncPackageRegistration,
} from '../services/syncRegistration';
import { readSyncDrift } from '../services/syncDrift';
import { syncServerBundle } from '../services/serverBundleSync';
import { syncWebBundle } from '../services/webBundleSync';
import {
  computeInputsHash,
...
import { HARNESS_STATE_POINTER, loadHarnessState } from '../services/harnessState';
...
import { loadDoomConfigLenient } from '../services/projectTrust';
import { createLayerResolvers, PERSONA_ENTRY, resolveExtensionComposition } from '../services/extensionAssembler';
...
import { SyncProgress, type SyncProgressOutput } from './syncPresenter';
