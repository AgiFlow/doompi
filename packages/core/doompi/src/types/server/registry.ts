 ...
 */
export interface SessionServerComposition {
  root: string;
  apiDirectory: string;
  generation: string;
  fingerprint: string;
...
export interface SessionRecord {
  ...
  /**
   * Socket speaking Pi's routed protocol, for Pi 0.85 clients.
   *
  ...
  /** Logical Pi 0.85 server identity expected at the protocol socket. */
  protocolServerId?: string;
  /** Pinned descriptor and effective startup selection, absent on legacy hosts. */
  serverComposition?: SessionServerComposition;
