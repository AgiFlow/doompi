...
import { updateHarnessState } from '../harnessState';
import { writeLauncherComposition } from '../launcherComposition';
import { ownEntry } from '../moduleResolution';
import { HARNESS_EVENT, type HarnessTelemetry } from '../logSinkTelemetry';
import { applyProjectTrust, hasProjectTrustOption, loadDoomConfig } from '../projectTrust';
import type { DoomConfig } from '../projectTrust';
import { LAUNCHER_COMPOSITION_ENV, LAUNCHER_COMPOSITION_VERSION } from '../../constants/launcherComposition';
...
export async function resolveLaunchPlan(
  ...
  const { buildRuntimeBundle, createRuntimeExtensionPlan } = await import('../runtimeBundle');
