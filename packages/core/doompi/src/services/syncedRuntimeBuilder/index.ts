...
import { compileExtensionSet, extensionSetManifestPath } from '../extensionCompiler';
...
import { createMapResolvers, readSyncState, type SyncState, syncDirectory, writeSyncState } from '../syncState';
