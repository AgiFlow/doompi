...
vi.mock('../../../../src/adapters/launchPlan', () => ({ resolveLaunchPlan: doompiMocks.resolveLaunchPlan }));
vi.mock('../../../../src/types/interfaces/launcherComposition', () => ({
  LAUNCHER_COMPOSITION_REQUEST_ENV: 'DOOMPI_COMPOSITION_RECORD',
}));
vi.mock('../../../../src/adapters/telemetry/logSinkTelemetry', () => telemetryMocks);
vi.mock('../../../../src/adapters/modules/moduleResolution', () => utilsMocks);

const { createDoomAgentLauncher, pinnedDoomPiCli } =
  await import('../../../../src/adapters/server/doomAgentLauncher.ts');
