/** Wire values returned by the global and workspace configuration mounts. */
...
export const SETTINGS_CONFIG_API_ROUTE = '/config';
export const SETTINGS_VALUE_API_ROUTE = '/value';
export const SETTINGS_REPOSITORIES_API_ROUTE = '/repositories';
export const SETTINGS_MODELS_API_ROUTE = '/models';
export const SETTINGS_REPOSITORY_API_ROUTE = '/repository';
export const SETTINGS_REPOSITORY_SELECTION_API_ROUTE = '/repository/selection';
export const SETTINGS_IMAGES_API_ROUTE = '/images';
