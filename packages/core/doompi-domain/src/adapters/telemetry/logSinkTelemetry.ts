...
const PACKAGE_NAME = '@agimon-ai/doompi-domain';

export interface DomainTelemetryOptions {
  cwd?: string;
...
export function createDomainTelemetry(options: DomainTelemetryOptions = {}): DomainTelemetry {
