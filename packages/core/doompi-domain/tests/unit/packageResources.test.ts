...
it('resolves the domain authoring skill from source and compiled module locations', async () => {
  const skill = 'src/prompts/doompi-author-domain/SKILL.md';
  ...
  expect(content).toContain('doompi-author-domain');
