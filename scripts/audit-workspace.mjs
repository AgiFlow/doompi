...
if (packageDirectories.length !== 53 || ownedNames.size !== 53) {
  fail(
    `Expected exactly 53 DoomPi packages, found ${packageDirectories.length} directories and ${ownedNames.size} names`,
  );
}
